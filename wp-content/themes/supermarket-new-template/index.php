...
<?php get_template_part('tpl', 'slider');?>
    ...
    <script src="<?php echo TEMPLATE_PATH?>/js/jquery.nicescroll.min.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/jquery-ui.js"></script>
    <!-- ALL PLUGINS -->
    <script src="<?php echo TEMPLATE_PATH?>/js/jquery.superslides.min.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/bootstrap-select.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/inewsticker.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/bootsnav.js."></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/images-loded.min.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/isotope.min.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/owl.carousel.min.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/baguetteBox.min.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/form-validator.min.js"></script>
    <script src="<?php echo TEMPLATE_PATH?>/js/contact-form-script.js"></script>
